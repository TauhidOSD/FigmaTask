      ...
      {/* Section 4 */}
        ...
        <div className="space-y-4 px-4 sm:px-6 md:px-8 lg:ml-28 lg:mr-24">
            ...
            <ul className="list-disc list-inside text-left text-sm font-sans  leading-relaxed" >
                <li> <span className="font-plus-jakarta font-normal text-[rgba(121,121,121,1)]">Gerichte advertenties op platforms zoals Instagram en TikTok om de juiste doelgroep te bereiken.</span></li>
                 <li> <span className="font-plus-jakarta font-normal text-[rgba(121,121,121,1)]">Visuele storytelling waarbij de Henna-artist centraal staat.</span></li>
                 <li> <span className="font-plus-jakarta font-normal  text-[rgba(121,121,121,1)]">Interactie met volgers om engagement te verhogen en vertrouwen op te bouwen.</span></li>
                 <li> <span className="font-plus-jakarta font-normal  text-[rgba(121,121,121,1)]">Samenwerkingen met influencers en tevreden klanten om organische groei te stimuleren.</span></li>
            ...
            <ul className="list-disc list-inside text-left text-sm font-sans  leading-relaxed" >
                <li> <span className="font-plus-jakarta font-normal text-[rgba(121,121,121,1)]">Het verbeteren van de vindbaarheid op zoekmachines zoals Google.</span></li>
                 <li> <span className="font-plus-jakarta font-normal text-[rgba(121,121,121,1)]">Het ontwikkelen van een sterke contentstrategie via blogs en tutorials over henna-kunst.</span></li>
                 <li> <span className="font-plus-jakarta font-normal  text-[rgba(121,121,121,1)]">Het verkrijgen van backlinks en samenwerkingen met relevante platforms.</span></li>
