        ...
        <div className="px-4 md:px-10 space-y-6">
          ...
          <div className="space-y-4 px-4 sm:px-6 md:px-8 lg:ml-20 lg:mr-20">
            ...
            <ul className="list-disc list-inside text-left text-sm font-sans  leading-relaxed" >
                <li> <span className="text-[22px] font-normal font-plus-jakarta text-[rgba(121,121,121,1)]">Kleurgebruik: FINGUIDE maakt gebruik van een eenvoudig en strak kleurenpalet dat draait om blauw- en grijstonen, gecombineerd met subtiele accentkleuren. Blauw staat voor betrouwbaarheid en stabiliteit, terwijl de zachte grijstinten een moderne en professionele uitstraling geven.</span></li>

                 <li> <span className="text-[22px] font-normal font-plus-jakarta text-[rgba(121,121,121,1)]">Gebruiksvriendelijke interface: De app ziet er niet uit als een traditioneel, complex boekhoudprogramma. Heldere visuals, duidelijke instructies en een gestroomlijnd dashboard maken het gebruik laagdrempelig.</span></li>

                 <li> <span className="text-[22px] font-normal font-plus-jakarta text-[rgba(121,121,121,1)]">Educatieve content: FINGUIDE biedt meer dan alleen software; het is een bron van kennis. Door middel van tutorials en casestudy’s met echte ondernemers wordt boekhouden begrijpelijk en toepasbaar gemaakt.</span></li>
          ...
          <div className="space-y-4 px-4 sm:px-6 md:px-8 lg:ml-20 lg:mr-20">
            ...
            <ul className="list-disc list-inside text-left text-sm font-sans  leading-relaxed" >
                <li> <span className="text-[22px] font-normal font-plus-jakarta text-[rgba(121,121,121,1)]">Automatiseren van administratieve taken: Facturen uploaden, bonnetjes inscannen en direct verwerken.</span></li>
                 <li> <span className="text-[22px] font-normal font-plus-jakarta text-[rgba(121,121,121,1)]">Live inzicht in financiële status: Altijd een actueel overzicht van winst- en verliesrekeningen.</span></li>
                 <li> <span className="text-[22px] font-normal font-plus-jakarta text-[rgba(121,121,121,1)]">Cashflowberekeningen en prognoses: Helpt ondernemers vooruit te plannen en financiële valkuilen te vermijden.</span></li>
                 <li> <span className="text-[22px] font-normal font-plus-jakarta text-[rgba(121,121,121,1)]">Slimme belastingadviezen: Gericht op het mkb en zzpers, zodat ook kleine bedrijven optimaal profiteren van fiscale voordelen.
