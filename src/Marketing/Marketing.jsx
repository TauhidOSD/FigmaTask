...
const Marketing = () => {
  ...
  return (
    ...
    <div className=" mx-auto md:px-6 px-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center lg:px-12 mt-10 lg:m-20 ">
        <div className="mr-5">
          ...
          <p className="text-left text-base lg:text-lg text-slate-500">
            ...
            technologie met data-gedreven strategieën om uw merk zichtbaarder te
      ...
      <h1 className=" text-[30px] lg:text-[40px] text-center font-bold font-plus-jakarta">
          ...
          <div>
            ...
            {activeSection === "logo" && (
              <p className="mt-2 text-gray-600">
                Onze eerste stap is het creëren van een doordachte strategie die
                gericht is op jouw specifieke doelen en doelgroepen. We starten
                met een grondige analyse van je bedrijf, merk en de markt waarin
                je opereert. Op basis hiervan ontwikkelen we een strategisch
                plan dat gericht is op het maximaliseren van je
          ...
          <div>
            ...
            {activeSection === "visualGuidelines" && (
              <p className="mt-2 text-gray-600">
                ...
                het effectief bereiken van je doelgroep. We zorgen ervoor dat je
                merk zich onderscheidt met unieke campagnes die jouw klanten
                aanspreken. Of het nu gaat om online advertenties of offline
                marketing zoals onze straatsteen marketing, we creëren campagnes
                die niet alleen opvallen, maar ook impact maken. Jij bent geen
                nummer voor ons, we zorgen ervoor dat de boodschap aansluit bij
                jouw merkidentiteit en klantbehoeften.
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {activeSection === "printMedia" && (
              <p className="mt-2 text-gray-600">
                ...
                monitoren en analyseren de resultaten voortdurend om te zien wat
                werkt en waar we kunnen verbeteren. Door gebruik te maken van
                verschillende marketingtools optimaliseren we de campagnes voor
                de beste prestaties. We passen onze strategieën aan op basis van
                data en feedback, zodat jouw marketinginspanningen altijd
                blijven groeien en verbeteren. Zo zorgen we ervoor dat je de
                beste resultaten haalt zonder verspilling van middelen
              </p>
            )}
          </div>
        </div>
      ...
      <div className=" relative bg-custom-bg lg:bg-cover bg-center bg-slate-50 w-full mt-36 h-60  lg:w-auto  ">
        <div className="text-center md:ml-[428px]  absolute mx-auto   md:mt-16 ">
          <h1 className="font-bold text-xl lg:text-2xl ">
            Word onderdeel van onze groeiende
          </h1>
          <h1 className="font-bold text-xl lg:text-2xl">
        ...
        <div className="w-full lg:mt-10 lg:ml-56 lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white shadow-md rounded-lg p-6 space-y-4">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              zorgde voor een enorme stijging in boekingen met een klein budget.
              De campagne was zo succesvol dat ik hem zelfs tijdelijk moest
              stopzetten!”
            </p>
          </div>
