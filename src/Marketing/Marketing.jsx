...
const Marketing = () => {
  ...
  const toggleSection = (section) => {
    ...
    return (
        ...
        <div className="mt-5 mr-6"><button className="btn btn-sm btn-info lg:w-40">Neem contact op</button></div>

        </div>

                <div className="mt-10"><img className="w-full" src="/linkImages/pana.png" alt="" /></div>
        </div>
