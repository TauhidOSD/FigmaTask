...
const Diensten = () => {
  ...
  <p className="text-[#7E7E7E] leading-relaxed font-semibold px-4 sm:px-12 md:px-24 lg:px-36 xl:px-72">
    Bij Younitech geloven we in de kracht van een sterke merkidentiteit. Onze
    brandingdiensten zijn ontworpen om uw bedrijf te laten opvallen in een
    competitieve markt. Wij bieden:
  </p>
</div>
