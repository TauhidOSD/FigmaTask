...
const Diensten = () => {
  ...
  <div className="flex flex-col  items-center text-center  p-6 space-y-4">
    <div className="w-16 h-16 flex justify-center items-center bg-blue-100 rounded-full">
      <img src={icon} alt="Strategische Merkontwikkeling" className="w-8 h-8" />
    </div>
    <h2 className="text-lg font-semibold text-gray-800">Strategische Merkontwikkeling</h2>
  ...
  <div className="flex flex-col items-center text-center  p-6 space-y-4">
    ...
    <h2 className="text-lg font-semibold text-gray-800">Grafisch <br /> Ontwerp</h2>
    <p className="text-sm text-gray-600">
  ...
  <div className="flex flex-col items-center text-center  p-6 space-y-4">
    <div className="w-16 h-16 flex justify-center items-center bg-blue-100 rounded-full">
      <img src={icon2} alt="Ontwikkeling van Visuele Stijl" className="w-8 h-8" />
    </div>
    <h2 className="text-lg font-semibold text-gray-800">Ontwikkeling <br /> van Visuele Stijl</h2>
    <p className="text-sm text-gray-600">
  ...
  <div className="flex flex-col items-center text-center  p-6 space-y-4">
    ...
    <h2 className="text-lg font-semibold text-gray-800">Campagnes <br /> en Promotie</h2>
    <p className="text-sm text-gray-600">
