    ...
    return (
        ...
        <div className="px-4 md:px-10 space-y-6">
          ...
          <div className="space-y-4 px-4 sm:px-6 md:px-8 lg:ml-20 lg:mr-20">
            <h1 className="text-lg font-medium">SEO: Duurzame Vindbaarheid met Hoog Rendement</h1>
            <p className="text-left text-sm text-slate-500 leading-relaxed">
            ...
            <ul className="list-disc list-inside text-left text-sm font-sans  leading-relaxed" >
                <li> <span className="text-[rgba(121,121,121,1)]">Contentcreatie: Regelmatige, waardevolle en goed geoptimaliseerde content die zowel klanten als zoekmachines aanspreekt.</span></li>
                 <li> <span className="text-[rgba(121,121,121,1)]">Technische SEO: Een snelle, gebruiksvriendelijke website met een sterke structuur en mobiele optimalisatie.</span></li>
                 <li> <span className="text-[rgba(121,121,121,1)]">Linkbuilding: Kwalitatieve backlinks om de autoriteit en zichtbaarheid te vergroten</span></li>
            </ul>
            <p className="text-left text-sm text-slate-500 leading-relaxed">SEO is een lange-termijnstrategie, maar wanneer goed uitgevoerd, levert het een duurzame en kosteneffectieve stroom van organisch verkeer op. Dit bespaart uiteindelijk op advertentiekosten en zorgt voor een stabiele groei.</p>
          </div>
        </div>
        ...
        <div className="px-4 md:px-10 space-y-6">
          ...
          <div className="space-y-4 px-4 sm:px-6 md:px-8 lg:ml-20 lg:mr-20">
            <h1 className="text-lg font-medium">SMMA: Gericht en Meetbaar Succes op Sociale Media</h1>
            <p className="text-left text-sm text-slate-500 leading-relaxed">
            ...
            <ul className="list-disc list-inside text-left text-sm font-sans  leading-relaxed" >
                <li> <span className="text-[rgba(121,121,121,1)]">Snelle, agressieve aanpak: In de eerste fase zetten we krachtige advertenties in om zichtbaarheid te vergroten en data te verzamelen.</span></li>
                 <li> <span className="text-[rgba(121,121,121,1)]">Gerichte targeting: We analyseren onze doelgroep en testen verschillende advertentievarianten om de meest kosteneffectieve strategie te bepalen.</span></li>
                 <li> <span className="text-[rgba(121,121,121,1)]">Conversiegerichte content: Creatieve posts, reels en interacties om engagement te stimuleren en organische groei te bevorderen.</span></li>
                 <li> <span className="text-[rgba(121,121,121,1)]">Retargeting en optimalisatie: We hergebruiken verzamelde data om advertenties slimmer en efficiënter te maken.
        ...
        <div className="px-4 md:px-10 space-y-6">
          ...
          <div className="space-y-4 px-4 sm:px-6 md:px-8 lg:ml-20 lg:mr-20">
            <h1 className="text-lg font-medium">Alternatieve Online en Offline Marketing: Slimme Strategieën die Werken</h1>
            <p className="text-left text-sm text-slate-500 leading-relaxed">
            ...
            <ul className="list-disc list-inside text-left text-sm font-sans  leading-relaxed" >
                <li> <span className="text-[rgba(121,121,121,1)]">Netwerkevenementen en beurzen waar strategische partnerships worden gevormd.</span></li>
                 <li> <span className="text-[rgba(121,121,121,1)]">Lokale samenwerkingen en sponsoring voor gerichte zichtbaarheid.</span></li>
                 <li> <span className="text-[rgba(121,121,121,1)]">Flyers en promotieacties op de juiste locaties voor maximale impact.</span></li>
                 
            </ul>
            <h1>Maximale Impact met Minimale Kosten</h1>
            <p className="text-left text-sm text-slate-500 leading-relaxed">Onze marketingstrategie draait om slimme keuzes, data-gestuurde optimalisatie en een efficiënte besteding van budgetten. Door niet klakkeloos te concurreren op dure advertentiekanalen, maar juist te focussen op slimme alternatieve methoden, behalen we maximale impact tegen minimale kosten. Dit stelt ons in staat om niet alleen succesvol, maar ook duurzaam te groeien.</p>
          </div>
        </div>
