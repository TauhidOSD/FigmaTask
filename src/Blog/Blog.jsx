    ...
    <div>
      <div className=" grid grid-cols-1 lg:grid-cols-3 ml-10 mt-20 mr-10 mb-20 gap-6 md:px-28">
        <div className="">
          ...
          <h1 className="mb-10 text-xl font-bold mt-6 text-left">
            “5 manieren om uw website te laten opvallen”
          </h1>
          <p className="text-slate-400 text-left text-xs">
            Een goed ontworpen website is meer dan een visitekaartje
          </p>
          <p className="text-slate-400 text-left text-xs">
            Leer hoe u met design, snelheid en content uw conversies..
          </p>

          <div className="flex justify-start mt-5 ">
            <button className="btn btn-sm btn-info text-slate-200">
              Lees meer
            </button>
          </div>
        </div>
        ...
        <div className="">
          ...
          <div className="flex justify-start mt-5">
            <button className="btn btn-sm text-slate-200 btn-info">
              Lees meer
            </button>
          </div>
        </div>
